...
public class TitlePlayerNewbie extends Newbie {	
	...
	public TitlePlayerNewbie(final EverInformations plugin) {
		super(plugin);
	...
	private class TitleOthers {
		private final TitlePlayerNewbie chat;
		private final EPlayer player;
		private int numero;
		private Task task;
		
		protected TitleOthers(final TitlePlayerNewbie chat, final EPlayer player) {
			this.chat = chat;
			this.player = player;
		...
		protected void view() {
			TitleMessage message = this.getMessage();
			this.chat.plugin.getLogger().debug("TitlePlayerNewbie (player='" + player.getIdentifier() + "',message='" + message + "')");
