...
public class BelowNameObjective extends EObjective {
	...
	public BelowNameObjective(final EverInformations plugin, final double stay, final double update, ScoreType type, Text name) {
	...
	public String toString() {
		return "BelowNameObjective [stay=" + stay + ", type=" + this.type.getName()
